...
contract DEXgastracker is IDEXclient {
  ...
  address walletAddr;
	...
	uint address_rootA = 0xcf5d9b0d7fe0dd14f8d75b9c511fab9805ae64dc4c1f08b955c69e44193518a1;
    address rootA = address(address_rootA);
    uint address_rootB =  0xeaa4b8e54760d2922d6e23da188d7a2c6824ed108a7c15be5de7b97d9740253e;
    address rootB = address(address_rootB);
